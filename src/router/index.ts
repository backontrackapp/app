  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'flashcards/review/set/:reviewSetId', name: 'flashcard-review-set-runner', component: () => import('@/views/FlashcardReviewRunnerView.vue'), meta: { title: 'Review', immersive: true, allowsLandscape: true, pageDepth: 2, pageOrder: 2, pageMotion: 'horizontal', backTo: '/tasks', alwaysBackTo: true } },
        { path: 'flashcards/review/:sessionId', name: 'flashcard-review-runner', component: () => import('@/views/FlashcardReviewRunnerView.vue'), meta: { title: 'Review', immersive: true, allowsLandscape: true, pageDepth: 2, pageOrder: 2, pageMotion: 'horizontal', backTo: '/tasks', alwaysBackTo: true } },
        ...
        { path: 'programs/run/:taskId', name: 'program-runner', component: () => import('@/views/ProgramRunnerView.vue'), meta: { title: 'Program', immersive: true, allowsLandscape: true, pageDepth: 2, pageOrder: 0, pageMotion: 'horizontal', backTo: '/tasks', alwaysBackTo: true } },
        ...
        { path: 'intervals/run/template/:templateId', name: 'interval-template-runner', component: () => import('@/views/IntervalRunnerView.vue'), meta: { title: 'Interval', immersive: true, allowsLandscape: true, pageDepth: 2, pageOrder: 1, backTo: '/tasks', alwaysBackTo: true } },
        { path: 'intervals/run/:sessionId', name: 'interval-runner', component: () => import('@/views/IntervalRunnerView.vue'), meta: { title: 'Interval', immersive: true, allowsLandscape: true, pageDepth: 2, pageOrder: 1, backTo: '/tasks', alwaysBackTo: true } },
