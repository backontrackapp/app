    ...
    private function tools(): array
    {
        ...
        return [
            ...
            $this->tool('update_flashcard_review_set', 'Propose changing the name or review settings of one owned Review set. Read the set first, then use null for every unchanged field.', [
                ...
                'front_seconds' => ['type' => ['integer', 'null'], 'minimum' => 1, 'maximum' => 10],
                'back_seconds' => ['type' => ['integer', 'null'], 'minimum' => 1, 'maximum' => 10],
                'back_speech_repeat_count' => ['type' => ['integer', 'null'], 'minimum' => 1, 'maximum' => 5],
                'front_display' => ['type' => ['string', 'null'], 'enum' => ['front', 'back', 'transliteration', 'note', 'image', 'empty', null]],
                'back_display' => ['type' => ['string', 'null'], 'enum' => ['front', 'back', 'transliteration', 'note', 'image', 'empty', null]],
                ...
                'review_set_id', 'name', 'mode', 'run_indefinitely',
