...
{
    public const EXPECTED_SCHEMA_VERSION = '202609040001';
    ...
    public function assertCompatibleSchema(): void
    {
        $required = [
            ...
            'flashcards' => [
                ...
                'tags', 'archived', 'created_at', 'updated_at', 'last_reviewed_at', 'last_ejected_at',
            ...
            'tasks' => [
                ...
                'color', 'icon', 'interval_template', 'flashcard_review_set',
            ...
            'interval_templates' => [
                'id', 'owner', 'name', 'description', 'icon', 'color', 'definition',
