        ...
        self::$collections = [
            ...
            'flashcard_review_sets' => [
                'fields' => [
                    ...
                    'front_display' => self::choice(['front', 'back', 'transliteration', 'note', 'image'], true),
                    'back_display' => self::choice(['front', 'back', 'transliteration', 'note', 'image'], true),
            ...
            'flashcard_review_sessions' => [
                'fields' => [
                    ...
                    'front_display_snapshot' => self::choice(['front', 'back', 'transliteration', 'note', 'image'], true),
                    'back_display_snapshot' => self::choice(['front', 'back', 'transliteration', 'note', 'image'], true),
