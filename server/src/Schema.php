        ...
        self::$collections = [
            ...
            'flashcard_review_sets' => [
                'fields' => [
                    ...
                    'eject_exclude_after' => self::integer(1, 20),
                    'front_seconds' => self::integer(1, 10),
                    'back_seconds' => self::integer(1, 10),
                    'back_speech_repeat_count' => self::integer(1, 5),
                    'front_display' => self::choice(['front', 'back', 'transliteration', 'note', 'image', 'empty'], true),
                    'back_display' => self::choice(['front', 'back', 'transliteration', 'note', 'image', 'empty'], true),
            ...
            'flashcard_review_sessions' => [
                'fields' => [
                    ...
                    'eject_exclude_after_snapshot' => self::integer(1, 20),
                    ...
                    'front_seconds_snapshot' => self::integer(1, 10),
                    'back_seconds_snapshot' => self::integer(1, 10),
                    'back_speech_repeat_count_snapshot' => self::integer(1, 5),
                    'front_display_snapshot' => self::choice(['front', 'back', 'transliteration', 'note', 'image', 'empty'], true),
                    'back_display_snapshot' => self::choice(['front', 'back', 'transliteration', 'note', 'image', 'empty'], true),
            ...
            'tracking_trackers' => [
                ...
                'required' => [
                    'name', 'role', 'kind', 'favorable_direction',
                    'daily_aggregation',
                ],
                'sort' => ['name', 'sort_order'],
                'filter' => ['active', 'archived', 'role', 'kind'],
            ],
            'tracking_entries' => [
                'fields' => [
                    ...
                    'note' => self::text(2000),
                    'source_type' => self::choice(['health_connect'], false, true),
                    'source_session' => self::text(80),
                ],
